-- M321: RateLimiting System
-- Migration 821_822

CREATE TABLE IF NOT EXISTS m321_ratelimiting_state (
...
CREATE INDEX idx_m321_ratelimiting_state_created_at ON m321_ratelimiting_state(created_at);
CREATE INDEX idx_m321_ratelimiting_state_metadata ON m321_ratelimiting_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m321_ratelimiting_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m321_ratelimiting_metrics_created_at ON m321_ratelimiting_metrics(created_at);
CREATE INDEX idx_m321_ratelimiting_metrics_metadata ON m321_ratelimiting_metrics USING GIN(metadata);
