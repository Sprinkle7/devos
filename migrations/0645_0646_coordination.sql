-- M233: Coordination System
-- Migration 645_646

CREATE TABLE IF NOT EXISTS m233_coordination_state (
...
CREATE INDEX idx_m233_coordination_state_created_at ON m233_coordination_state(created_at);
CREATE INDEX idx_m233_coordination_state_metadata ON m233_coordination_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m233_coordination_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m233_coordination_metrics_created_at ON m233_coordination_metrics(created_at);
CREATE INDEX idx_m233_coordination_metrics_metadata ON m233_coordination_metrics USING GIN(metadata);
