-- M306: Partition System
-- Migration 791_792

CREATE TABLE IF NOT EXISTS m306_partition_state (
...
CREATE INDEX idx_m306_partition_state_created_at ON m306_partition_state(created_at);
CREATE INDEX idx_m306_partition_state_metadata ON m306_partition_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m306_partition_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m306_partition_metrics_created_at ON m306_partition_metrics(created_at);
CREATE INDEX idx_m306_partition_metrics_metadata ON m306_partition_metrics USING GIN(metadata);
