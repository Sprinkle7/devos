-- M252: Lookahead System
-- Migration 683_684

CREATE TABLE IF NOT EXISTS m252_lookahead_state (
...
CREATE INDEX idx_m252_lookahead_state_created_at ON m252_lookahead_state(created_at);
CREATE INDEX idx_m252_lookahead_state_metadata ON m252_lookahead_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m252_lookahead_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m252_lookahead_metrics_created_at ON m252_lookahead_metrics(created_at);
CREATE INDEX idx_m252_lookahead_metrics_metadata ON m252_lookahead_metrics USING GIN(metadata);
