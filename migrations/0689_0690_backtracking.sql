-- M255: Backtracking System
-- Migration 689_690

CREATE TABLE IF NOT EXISTS m255_backtracking_state (
...
CREATE INDEX idx_m255_backtracking_state_created_at ON m255_backtracking_state(created_at);
CREATE INDEX idx_m255_backtracking_state_metadata ON m255_backtracking_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m255_backtracking_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m255_backtracking_metrics_created_at ON m255_backtracking_metrics(created_at);
CREATE INDEX idx_m255_backtracking_metrics_metadata ON m255_backtracking_metrics USING GIN(metadata);
