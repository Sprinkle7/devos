-- M332: Atomicity System
-- Migration 843_844

CREATE TABLE IF NOT EXISTS m332_atomicity_state (
...
CREATE INDEX idx_m332_atomicity_state_created_at ON m332_atomicity_state(created_at);
CREATE INDEX idx_m332_atomicity_state_metadata ON m332_atomicity_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m332_atomicity_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m332_atomicity_metrics_created_at ON m332_atomicity_metrics(created_at);
CREATE INDEX idx_m332_atomicity_metrics_metadata ON m332_atomicity_metrics USING GIN(metadata);
