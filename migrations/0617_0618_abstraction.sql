-- M219: Abstraction System
-- Migration 617_618

CREATE TABLE IF NOT EXISTS m219_abstraction_state (
...
CREATE INDEX idx_m219_abstraction_state_created_at ON m219_abstraction_state(created_at);
CREATE INDEX idx_m219_abstraction_state_metadata ON m219_abstraction_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m219_abstraction_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m219_abstraction_metrics_created_at ON m219_abstraction_metrics(created_at);
CREATE INDEX idx_m219_abstraction_metrics_metadata ON m219_abstraction_metrics USING GIN(metadata);
