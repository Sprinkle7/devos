-- M253: TreeSearch System
-- Migration 685_686

CREATE TABLE IF NOT EXISTS m253_treesearch_state (
...
CREATE INDEX idx_m253_treesearch_state_created_at ON m253_treesearch_state(created_at);
CREATE INDEX idx_m253_treesearch_state_metadata ON m253_treesearch_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m253_treesearch_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m253_treesearch_metrics_created_at ON m253_treesearch_metrics(created_at);
CREATE INDEX idx_m253_treesearch_metrics_metadata ON m253_treesearch_metrics USING GIN(metadata);
