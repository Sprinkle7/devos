-- M331: Transaction System
-- Migration 841_842

CREATE TABLE IF NOT EXISTS m331_transaction_state (
...
CREATE INDEX idx_m331_transaction_state_created_at ON m331_transaction_state(created_at);
CREATE INDEX idx_m331_transaction_state_metadata ON m331_transaction_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m331_transaction_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m331_transaction_metrics_created_at ON m331_transaction_metrics(created_at);
CREATE INDEX idx_m331_transaction_metrics_metadata ON m331_transaction_metrics USING GIN(metadata);
