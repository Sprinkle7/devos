...
CREATE TABLE IF NOT EXISTS m282_testing_state (
...
CREATE INDEX idx_m282_testing_state_created_at ON m282_testing_state(created_at);
CREATE INDEX idx_m282_testing_state_metadata ON m282_testing_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m282_testing_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m282_testing_metrics_created_at ON m282_testing_metrics(created_at);
CREATE INDEX idx_m282_testing_metrics_metadata ON m282_testing_metrics USING GIN(metadata);
