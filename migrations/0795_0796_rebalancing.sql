-- M308: Rebalancing System
-- Migration 795_796

CREATE TABLE IF NOT EXISTS m308_rebalancing_state (
...
CREATE INDEX idx_m308_rebalancing_state_created_at ON m308_rebalancing_state(created_at);
CREATE INDEX idx_m308_rebalancing_state_metadata ON m308_rebalancing_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m308_rebalancing_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m308_rebalancing_metrics_created_at ON m308_rebalancing_metrics(created_at);
CREATE INDEX idx_m308_rebalancing_metrics_metadata ON m308_rebalancing_metrics USING GIN(metadata);
