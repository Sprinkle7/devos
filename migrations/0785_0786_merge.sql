...
CREATE TABLE IF NOT EXISTS m303_merge_state (
...
CREATE INDEX idx_m303_merge_state_created_at ON m303_merge_state(created_at);
CREATE INDEX idx_m303_merge_state_metadata ON m303_merge_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m303_merge_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m303_merge_metrics_created_at ON m303_merge_metrics(created_at);
CREATE INDEX idx_m303_merge_metrics_metadata ON m303_merge_metrics USING GIN(metadata);
