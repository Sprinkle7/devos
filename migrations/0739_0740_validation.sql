-- M280: Validation System
-- Migration 739_740

CREATE TABLE IF NOT EXISTS m280_validation_state (
...
CREATE INDEX idx_m280_validation_state_created_at ON m280_validation_state(created_at);
CREATE INDEX idx_m280_validation_state_metadata ON m280_validation_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m280_validation_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m280_validation_metrics_created_at ON m280_validation_metrics(created_at);
CREATE INDEX idx_m280_validation_metrics_metadata ON m280_validation_metrics USING GIN(metadata);
