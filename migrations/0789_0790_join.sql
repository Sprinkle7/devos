...
CREATE TABLE IF NOT EXISTS m305_join_state (
...
CREATE INDEX idx_m305_join_state_created_at ON m305_join_state(created_at);
CREATE INDEX idx_m305_join_state_metadata ON m305_join_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m305_join_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m305_join_metrics_created_at ON m305_join_metrics(created_at);
CREATE INDEX idx_m305_join_metrics_metadata ON m305_join_metrics USING GIN(metadata);
