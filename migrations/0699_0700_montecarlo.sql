-- M260: MonteCarlo System
-- Migration 699_700

CREATE TABLE IF NOT EXISTS m260_montecarlo_state (
...
CREATE INDEX idx_m260_montecarlo_state_created_at ON m260_montecarlo_state(created_at);
CREATE INDEX idx_m260_montecarlo_state_metadata ON m260_montecarlo_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m260_montecarlo_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m260_montecarlo_metrics_created_at ON m260_montecarlo_metrics(created_at);
CREATE INDEX idx_m260_montecarlo_metrics_metadata ON m260_montecarlo_metrics USING GIN(metadata);
