-- M250: BeamSearch System
-- Migration 679_680

CREATE TABLE IF NOT EXISTS m250_beamsearch_state (
...
CREATE INDEX idx_m250_beamsearch_state_created_at ON m250_beamsearch_state(created_at);
CREATE INDEX idx_m250_beamsearch_state_metadata ON m250_beamsearch_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m250_beamsearch_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m250_beamsearch_metrics_created_at ON m250_beamsearch_metrics(created_at);
CREATE INDEX idx_m250_beamsearch_metrics_metadata ON m250_beamsearch_metrics USING GIN(metadata);
