-- M274: Encoding System
-- Migration 727_728

CREATE TABLE IF NOT EXISTS m274_encoding_state (
...
CREATE INDEX idx_m274_encoding_state_created_at ON m274_encoding_state(created_at);
CREATE INDEX idx_m274_encoding_state_metadata ON m274_encoding_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m274_encoding_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m274_encoding_metrics_created_at ON m274_encoding_metrics(created_at);
CREATE INDEX idx_m274_encoding_metrics_metadata ON m274_encoding_metrics USING GIN(metadata);
