-- M276: Compression System
-- Migration 731_732

CREATE TABLE IF NOT EXISTS m276_compression_state (
...
CREATE INDEX idx_m276_compression_state_created_at ON m276_compression_state(created_at);
CREATE INDEX idx_m276_compression_state_metadata ON m276_compression_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m276_compression_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m276_compression_metrics_created_at ON m276_compression_metrics(created_at);
CREATE INDEX idx_m276_compression_metrics_metadata ON m276_compression_metrics USING GIN(metadata);
