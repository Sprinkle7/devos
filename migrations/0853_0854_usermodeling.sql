-- M337: UserModeling System
-- Migration 853_854

CREATE TABLE IF NOT EXISTS m337_usermodeling_state (
...
CREATE INDEX idx_m337_usermodeling_state_created_at ON m337_usermodeling_state(created_at);
CREATE INDEX idx_m337_usermodeling_state_metadata ON m337_usermodeling_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m337_usermodeling_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m337_usermodeling_metrics_created_at ON m337_usermodeling_metrics(created_at);
CREATE INDEX idx_m337_usermodeling_metrics_metadata ON m337_usermodeling_metrics USING GIN(metadata);
