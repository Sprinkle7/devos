-- M309: Migration System
-- Migration 797_798

CREATE TABLE IF NOT EXISTS m309_migration_state (
...
CREATE INDEX idx_m309_migration_state_created_at ON m309_migration_state(created_at);
CREATE INDEX idx_m309_migration_state_metadata ON m309_migration_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m309_migration_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m309_migration_metrics_created_at ON m309_migration_metrics(created_at);
CREATE INDEX idx_m309_migration_metrics_metadata ON m309_migration_metrics USING GIN(metadata);
