-- M264: Regression System
-- Migration 707_708

CREATE TABLE IF NOT EXISTS m264_regression_state (
...
CREATE INDEX idx_m264_regression_state_created_at ON m264_regression_state(created_at);
CREATE INDEX idx_m264_regression_state_metadata ON m264_regression_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m264_regression_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m264_regression_metrics_created_at ON m264_regression_metrics(created_at);
CREATE INDEX idx_m264_regression_metrics_metadata ON m264_regression_metrics USING GIN(metadata);
