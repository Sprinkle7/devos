-- M236: Optimization System
-- Migration 651_652

CREATE TABLE IF NOT EXISTS m236_optimization_state (
...
CREATE INDEX idx_m236_optimization_state_created_at ON m236_optimization_state(created_at);
CREATE INDEX idx_m236_optimization_state_metadata ON m236_optimization_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m236_optimization_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m236_optimization_metrics_created_at ON m236_optimization_metrics(created_at);
CREATE INDEX idx_m236_optimization_metrics_metadata ON m236_optimization_metrics USING GIN(metadata);
