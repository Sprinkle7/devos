-- M328: Redundancy System
-- Migration 835_836

CREATE TABLE IF NOT EXISTS m328_redundancy_state (
...
CREATE INDEX idx_m328_redundancy_state_created_at ON m328_redundancy_state(created_at);
CREATE INDEX idx_m328_redundancy_state_metadata ON m328_redundancy_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m328_redundancy_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m328_redundancy_metrics_created_at ON m328_redundancy_metrics(created_at);
CREATE INDEX idx_m328_redundancy_metrics_metadata ON m328_redundancy_metrics USING GIN(metadata);
