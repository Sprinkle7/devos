-- M237: Efficiency System
-- Migration 653_654

CREATE TABLE IF NOT EXISTS m237_efficiency_state (
...
CREATE INDEX idx_m237_efficiency_state_created_at ON m237_efficiency_state(created_at);
CREATE INDEX idx_m237_efficiency_state_metadata ON m237_efficiency_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m237_efficiency_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m237_efficiency_metrics_created_at ON m237_efficiency_metrics(created_at);
CREATE INDEX idx_m237_efficiency_metrics_metadata ON m237_efficiency_metrics USING GIN(metadata);
