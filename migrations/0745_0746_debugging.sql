-- M283: Debugging System
-- Migration 745_746

CREATE TABLE IF NOT EXISTS m283_debugging_state (
...
CREATE INDEX idx_m283_debugging_state_created_at ON m283_debugging_state(created_at);
CREATE INDEX idx_m283_debugging_state_metadata ON m283_debugging_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m283_debugging_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m283_debugging_metrics_created_at ON m283_debugging_metrics(created_at);
CREATE INDEX idx_m283_debugging_metrics_metadata ON m283_debugging_metrics USING GIN(metadata);
