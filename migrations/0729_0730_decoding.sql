-- M275: Decoding System
-- Migration 729_730

CREATE TABLE IF NOT EXISTS m275_decoding_state (
...
CREATE INDEX idx_m275_decoding_state_created_at ON m275_decoding_state(created_at);
CREATE INDEX idx_m275_decoding_state_metadata ON m275_decoding_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m275_decoding_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m275_decoding_metrics_created_at ON m275_decoding_metrics(created_at);
CREATE INDEX idx_m275_decoding_metrics_metadata ON m275_decoding_metrics USING GIN(metadata);
