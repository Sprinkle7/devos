-- M223: Comparison System
-- Migration 625_626

CREATE TABLE IF NOT EXISTS m223_comparison_state (
...
CREATE INDEX idx_m223_comparison_state_created_at ON m223_comparison_state(created_at);
CREATE INDEX idx_m223_comparison_state_metadata ON m223_comparison_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m223_comparison_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m223_comparison_metrics_created_at ON m223_comparison_metrics(created_at);
CREATE INDEX idx_m223_comparison_metrics_metadata ON m223_comparison_metrics USING GIN(metadata);
