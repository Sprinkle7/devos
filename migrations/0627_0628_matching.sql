-- M224: Matching System
-- Migration 627_628

CREATE TABLE IF NOT EXISTS m224_matching_state (
...
CREATE INDEX idx_m224_matching_state_created_at ON m224_matching_state(created_at);
CREATE INDEX idx_m224_matching_state_metadata ON m224_matching_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m224_matching_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m224_matching_metrics_created_at ON m224_matching_metrics(created_at);
CREATE INDEX idx_m224_matching_metrics_metadata ON m224_matching_metrics USING GIN(metadata);
