-- M327: Failover System
-- Migration 833_834

CREATE TABLE IF NOT EXISTS m327_failover_state (
...
CREATE INDEX idx_m327_failover_state_created_at ON m327_failover_state(created_at);
CREATE INDEX idx_m327_failover_state_metadata ON m327_failover_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m327_failover_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m327_failover_metrics_created_at ON m327_failover_metrics(created_at);
CREATE INDEX idx_m327_failover_metrics_metadata ON m327_failover_metrics USING GIN(metadata);
