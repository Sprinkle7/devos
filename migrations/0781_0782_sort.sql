...
CREATE TABLE IF NOT EXISTS m301_sort_state (
...
CREATE INDEX idx_m301_sort_state_created_at ON m301_sort_state(created_at);
CREATE INDEX idx_m301_sort_state_metadata ON m301_sort_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m301_sort_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m301_sort_metrics_created_at ON m301_sort_metrics(created_at);
CREATE INDEX idx_m301_sort_metrics_metadata ON m301_sort_metrics USING GIN(metadata);
