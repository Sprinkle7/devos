-- M266: Clustering System
-- Migration 711_712

CREATE TABLE IF NOT EXISTS m266_clustering_state (
...
CREATE INDEX idx_m266_clustering_state_created_at ON m266_clustering_state(created_at);
CREATE INDEX idx_m266_clustering_state_metadata ON m266_clustering_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m266_clustering_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m266_clustering_metrics_created_at ON m266_clustering_metrics(created_at);
CREATE INDEX idx_m266_clustering_metrics_metadata ON m266_clustering_metrics USING GIN(metadata);
