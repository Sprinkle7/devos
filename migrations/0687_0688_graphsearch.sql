-- M254: GraphSearch System
-- Migration 687_688

CREATE TABLE IF NOT EXISTS m254_graphsearch_state (
...
CREATE INDEX idx_m254_graphsearch_state_created_at ON m254_graphsearch_state(created_at);
CREATE INDEX idx_m254_graphsearch_state_metadata ON m254_graphsearch_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m254_graphsearch_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m254_graphsearch_metrics_created_at ON m254_graphsearch_metrics(created_at);
CREATE INDEX idx_m254_graphsearch_metrics_metadata ON m254_graphsearch_metrics USING GIN(metadata);
