...
CREATE TABLE IF NOT EXISTS m304_split_state (
...
CREATE INDEX idx_m304_split_state_created_at ON m304_split_state(created_at);
CREATE INDEX idx_m304_split_state_metadata ON m304_split_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m304_split_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m304_split_metrics_created_at ON m304_split_metrics(created_at);
CREATE INDEX idx_m304_split_metrics_metadata ON m304_split_metrics USING GIN(metadata);
