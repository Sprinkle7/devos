-- M281: Verification System
-- Migration 741_742

CREATE TABLE IF NOT EXISTS m281_verification_state (
...
CREATE INDEX idx_m281_verification_state_created_at ON m281_verification_state(created_at);
CREATE INDEX idx_m281_verification_state_metadata ON m281_verification_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m281_verification_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m281_verification_metrics_created_at ON m281_verification_metrics(created_at);
CREATE INDEX idx_m281_verification_metrics_metadata ON m281_verification_metrics USING GIN(metadata);
