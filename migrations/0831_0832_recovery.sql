-- M326: Recovery System
-- Migration 831_832

CREATE TABLE IF NOT EXISTS m326_recovery_state (
...
CREATE INDEX idx_m326_recovery_state_created_at ON m326_recovery_state(created_at);
CREATE INDEX idx_m326_recovery_state_metadata ON m326_recovery_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m326_recovery_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m326_recovery_metrics_created_at ON m326_recovery_metrics(created_at);
CREATE INDEX idx_m326_recovery_metrics_metadata ON m326_recovery_metrics USING GIN(metadata);
