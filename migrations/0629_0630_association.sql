-- M225: Association System
-- Migration 629_630

CREATE TABLE IF NOT EXISTS m225_association_state (
...
CREATE INDEX idx_m225_association_state_created_at ON m225_association_state(created_at);
CREATE INDEX idx_m225_association_state_metadata ON m225_association_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m225_association_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m225_association_metrics_created_at ON m225_association_metrics(created_at);
CREATE INDEX idx_m225_association_metrics_metadata ON m225_association_metrics USING GIN(metadata);
