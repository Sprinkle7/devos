-- M320: FlowControl System
-- Migration 819_820

CREATE TABLE IF NOT EXISTS m320_flowcontrol_state (
...
CREATE INDEX idx_m320_flowcontrol_state_created_at ON m320_flowcontrol_state(created_at);
CREATE INDEX idx_m320_flowcontrol_state_metadata ON m320_flowcontrol_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m320_flowcontrol_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m320_flowcontrol_metrics_created_at ON m320_flowcontrol_metrics(created_at);
CREATE INDEX idx_m320_flowcontrol_metrics_metadata ON m320_flowcontrol_metrics USING GIN(metadata);
