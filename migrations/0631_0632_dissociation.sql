-- M226: Dissociation System
-- Migration 631_632

CREATE TABLE IF NOT EXISTS m226_dissociation_state (
...
CREATE INDEX idx_m226_dissociation_state_created_at ON m226_dissociation_state(created_at);
CREATE INDEX idx_m226_dissociation_state_metadata ON m226_dissociation_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m226_dissociation_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m226_dissociation_metrics_created_at ON m226_dissociation_metrics(created_at);
CREATE INDEX idx_m226_dissociation_metrics_metadata ON m226_dissociation_metrics USING GIN(metadata);
