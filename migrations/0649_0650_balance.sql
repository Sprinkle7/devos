...
CREATE TABLE IF NOT EXISTS m235_balance_state (
...
CREATE INDEX idx_m235_balance_state_created_at ON m235_balance_state(created_at);
CREATE INDEX idx_m235_balance_state_metadata ON m235_balance_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m235_balance_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m235_balance_metrics_created_at ON m235_balance_metrics(created_at);
CREATE INDEX idx_m235_balance_metrics_metadata ON m235_balance_metrics USING GIN(metadata);
