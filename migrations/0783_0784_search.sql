...
CREATE TABLE IF NOT EXISTS m302_search_state (
...
CREATE INDEX idx_m302_search_state_created_at ON m302_search_state(created_at);
CREATE INDEX idx_m302_search_state_metadata ON m302_search_state USING GIN(metadata);

CREATE TABLE IF NOT EXISTS m302_search_metrics (
  id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX idx_m302_search_metrics_created_at ON m302_search_metrics(created_at);
CREATE INDEX idx_m302_search_metrics_metadata ON m302_search_metrics USING GIN(metadata);
