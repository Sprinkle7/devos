...
source_turn: 58
title: "SRS-012 Configuration"
status: extracted
---

Yes. This is exactly how we'll proceed.

And I want to make one more commitment before continuing:

> **I'm no longer optimizing for "writing documents." I'm optimizing for "building DEVAIOS."**

That means every requirement I write is something I expect to eventually become code.

---

# SRS-012 — Configuration Management System
...
## One architectural adjustment before SRS-013

After writing these first three SRS documents, I want to introduce a principle that I think will make DEVAIOS significantly cleaner:

> **Every subsystem should expose exactly one public service.**

For example:

- Configuration System → `ConfigurationService`
- Workspace System → `WorkspaceService`
- Plugin System → `PluginService`
- Brain → `BrainService`
- Knowledge → `KnowledgeService`

Internally, each subsystem can have many classes, managers, and helpers. Externally, every other part of DEVAIOS talks to a single, well-defined service interface.

This reduces coupling, makes testing easier, and gives us stable contracts for plugins, the CLI, the dashboard, and future SDKs. It's a pattern that's worked well in many modular systems, and I think it's a good fit for DEVAIOS as it grows.
