import {VoiceRecognitionSystemState, VoiceRecognitionSystemMetrics} from './types';
...
export class VoiceRecognitionSystem {
  ...
  getState(): VoiceRecognitionSystemState {
    this.updateMetrics();
    return {
  ...
  getMetrics(): VoiceRecognitionSystemMetrics {
    return {
