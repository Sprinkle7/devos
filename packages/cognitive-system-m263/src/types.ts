// M263: Statistical Learning System Types
export interface StatisticalLearningCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface StatisticalLearningState {
...
export interface StatisticalLearningMetrics {
