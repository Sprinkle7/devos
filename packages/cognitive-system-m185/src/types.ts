// M185: InhibitoryControl System Types
export interface InhibitoryControlSubsystem1 {
  id: string;
  metric_value: number; // 0-1.0
}
export interface InhibitoryControlState {
...
export interface InhibitoryControlMetrics {
