// M244: Cost Benefit Analysis System Types
export interface CostBenefitAnalysisCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface CostBenefitAnalysisState {
...
export interface CostBenefitAnalysisMetrics {
