import {InteroceptionSystemState, InteroceptionSystemMetrics} from './types';
...
export class InteroceptionSystem {
  ...
  getState(): InteroceptionSystemState {
    this.updateMetrics();
    return {
  ...
  getMetrics(): InteroceptionSystemMetrics {
    return {
