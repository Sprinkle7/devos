// M261: Probabilistic Inference System Types
export interface ProbabilisticInferenceCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface ProbabilisticInferenceState {
...
export interface ProbabilisticInferenceMetrics {
