// M329: Consistency Assurance System Types
export interface ConsistencyAssuranceCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface ConsistencyAssuranceState {
...
export interface ConsistencyAssuranceMetrics {
