// M336: Adaptation Learning System Types
export interface AdaptationLearningCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface AdaptationLearningState {
...
export interface AdaptationLearningMetrics {
