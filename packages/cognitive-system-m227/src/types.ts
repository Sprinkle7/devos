// M227: Integration Synthesis System Types
export interface IntegrationSynthesisCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface IntegrationSynthesisState {
...
export interface IntegrationSynthesisMetrics {
