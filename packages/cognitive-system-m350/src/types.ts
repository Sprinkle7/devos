// M350: Global Integration System Types
export interface GlobalIntegrationCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface GlobalIntegrationState {
...
export interface GlobalIntegrationMetrics {
