// M183: ConsciousnessMonitoring System Types
export interface ConsciousnessMonitoringSubsystem1 {
  id: string;
  metric_value: number; // 0-1.0
}
export interface ConsciousnessMonitoringState {
...
export interface ConsciousnessMonitoringMetrics {
