// M229: Hierarchical Organization System Types
export interface HierarchicalOrganizationCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface HierarchicalOrganizationState {
...
export interface HierarchicalOrganizationMetrics {
