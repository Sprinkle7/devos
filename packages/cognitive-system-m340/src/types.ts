// M340: Context Awareness System Types
export interface ContextAwarenessCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface ContextAwarenessState {
...
export interface ContextAwarenessMetrics {
