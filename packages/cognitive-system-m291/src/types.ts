// M291: Buffer Management System Types
export interface BufferManagementCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface BufferManagementState {
...
export interface BufferManagementMetrics {
