// M262: Bayesian Reasoning System Types
export interface BayesianReasoningCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface BayesianReasoningState {
...
export interface BayesianReasoningMetrics {
