// M198: AnxietyRegulation System Types
export interface AnxietyRegulationSubsystem1 {
  id: string;
  metric_value: number; // 0-1.0
}
export interface AnxietyRegulationState {
...
export interface AnxietyRegulationMetrics {
