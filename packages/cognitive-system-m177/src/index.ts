import {FacialExpressionRecognitionSystemState, FacialExpressionRecognitionSystemMetrics} from './types';
...
export class FacialExpressionRecognitionSystem {
  ...
  getState(): FacialExpressionRecognitionSystemState {
    this.updateMetrics();
    return {
  ...
  getMetrics(): FacialExpressionRecognitionSystemMetrics {
    return {
