// M222: Difference Detection System Types
export interface DifferenceDetectionCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface DifferenceDetectionState {
...
export interface DifferenceDetectionMetrics {
