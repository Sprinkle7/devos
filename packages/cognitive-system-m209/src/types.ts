// M209: Abstract Reasoning System Types
export interface AbstractReasoningCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface AbstractReasoningState {
...
export interface AbstractReasoningMetrics {
