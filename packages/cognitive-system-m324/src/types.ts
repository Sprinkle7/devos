// M324: Predictive Planning System Types
export interface PredictivePlanningCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface PredictivePlanningState {
...
export interface PredictivePlanningMetrics {
