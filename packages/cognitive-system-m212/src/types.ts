// M212: Metaphor Processing System Types
export interface MetaphorProcessingCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface MetaphorProcessingState {
...
export interface MetaphorProcessingMetrics {
