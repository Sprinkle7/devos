// M319: Congestion Management System Types
export interface CongestionManagementCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface CongestionManagementState {
...
export interface CongestionManagementMetrics {
