// M221: Similarity Assessment System Types
export interface SimilarityAssessmentCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface SimilarityAssessmentState {
...
export interface SimilarityAssessmentMetrics {
