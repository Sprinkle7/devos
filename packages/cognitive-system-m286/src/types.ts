// M286: Latency Measurement System Types
export interface LatencyMeasurementCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface LatencyMeasurementState {
...
export interface LatencyMeasurementMetrics {
