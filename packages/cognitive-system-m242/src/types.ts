// M242: Preference Weighting System Types
export interface PreferenceWeightingCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface PreferenceWeightingState {
...
export interface PreferenceWeightingMetrics {
