// M318: Bottleneck Detection System Types
export interface BottleneckDetectionCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface BottleneckDetectionState {
...
export interface BottleneckDetectionMetrics {
