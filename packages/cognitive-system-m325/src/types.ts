// M325: Contingency Management System Types
export interface ContingencyManagementCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface ContingencyManagementState {
...
export interface ContingencyManagementMetrics {
