// M248: State Space Exploration System Types
export interface StateSpaceExplorationCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface StateSpaceExplorationState {
...
export interface StateSpaceExplorationMetrics {
