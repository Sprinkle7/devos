// M191: NoveltyPreference System Types
export interface NoveltyPreferenceSubsystem1 {
  id: string;
  metric_value: number; // 0-1.0
}
export interface NoveltyPreferenceState {
...
export interface NoveltyPreferenceMetrics {
