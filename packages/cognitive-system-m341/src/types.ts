// M341: Situation Assessment System Types
export interface SituationAssessmentCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface SituationAssessmentState {
...
export interface SituationAssessmentMetrics {
