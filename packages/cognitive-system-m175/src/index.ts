import {EmotionalProcessingSystemState, EmotionalProcessingSystemMetrics} from './types';
...
export class EmotionalProcessingSystem {
  ...
  getState(): EmotionalProcessingSystemState {
    this.updateMetrics();
    return {
  ...
  getMetrics(): EmotionalProcessingSystemMetrics {
    return {
