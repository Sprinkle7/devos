// M347: Response Planning System Types
export interface ResponsePlanningCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface ResponsePlanningState {
...
export interface ResponsePlanningMetrics {
