// M245: Tradeoff Analysis System Types
export interface TradeoffAnalysisCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface TradeoffAnalysisState {
...
export interface TradeoffAnalysisMetrics {
