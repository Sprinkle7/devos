// M339: Behavior Prediction System Types
export interface BehaviorPredictionCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface BehaviorPredictionState {
...
export interface BehaviorPredictionMetrics {
