// M345: Anomaly Classification System Types
export interface AnomalyClassificationCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface AnomalyClassificationState {
...
export interface AnomalyClassificationMetrics {
