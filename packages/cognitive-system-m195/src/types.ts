// M195: BehavioralInhibition System Types
export interface BehavioralInhibitionSubsystem1 {
  id: string;
  metric_value: number; // 0-1.0
}
export interface BehavioralInhibitionState {
...
export interface BehavioralInhibitionMetrics {
