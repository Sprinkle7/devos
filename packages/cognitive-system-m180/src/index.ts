import {BodySchemaSystemState, BodySchemaSystemMetrics} from './types';
...
export class BodySchemaSystem {
  ...
  getState(): BodySchemaSystemState {
    this.updateMetrics();
    return {
  ...
  getMetrics(): BodySchemaSystemMetrics {
    return {
