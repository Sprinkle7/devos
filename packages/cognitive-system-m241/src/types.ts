// M241: Value Aggregation System Types
export interface ValueAggregationCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface ValueAggregationState {
...
export interface ValueAggregationMetrics {
