// M193: ExplorationMotivation System Types
export interface ExplorationMotivationSubsystem1 {
  id: string;
  metric_value: number; // 0-1.0
}
export interface ExplorationMotivationState {
...
export interface ExplorationMotivationMetrics {
