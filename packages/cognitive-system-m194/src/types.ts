// M194: BehavioralActivation System Types
export interface BehavioralActivationSubsystem1 {
  id: string;
  metric_value: number; // 0-1.0
}
export interface BehavioralActivationState {
...
export interface BehavioralActivationMetrics {
