// M285: Throughput Analysis System Types
export interface ThroughputAnalysisCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface ThroughputAnalysisState {
...
export interface ThroughputAnalysisMetrics {
