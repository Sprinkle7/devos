// M265: Classification Learning System Types
export interface ClassificationLearningCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface ClassificationLearningState {
...
export interface ClassificationLearningMetrics {
