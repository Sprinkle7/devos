// M314: Workload Balancing System Types
export interface WorkloadBalancingCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface WorkloadBalancingState {
...
export interface WorkloadBalancingMetrics {
