// M312: Process Coordination System Types
export interface ProcessCoordinationCore {
  id: string;
  core_metric: number; // 0-1.0
}
export interface ProcessCoordinationState {
...
export interface ProcessCoordinationMetrics {
